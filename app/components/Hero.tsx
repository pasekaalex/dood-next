  ...
  return (
    ...
    <section className="flex flex-col items-center justify-center text-center px-4 pt-2 pb-1">
      <div className="w-full max-w-xl mx-auto flex flex-col items-center gap-3">
        ...
        <img src="/logo.png" alt="Dood's" style={{borderRadius: '12px', border: '4px solid var(--primary)', boxShadow: '4px 4px 0 var(--primary)', maxHeight: '140px', width: '90%', objectFit: 'contain'}} />
        ...
        <div className="flex justify-center w-full">
          <a href="https://jup.ag/swap?sell=So11111111111111111111111111111111111111112&buy=4pzuXZwn4N2oGzrjnTv57FkD31eSqwnhx4w96uH1pump"
            ...
            style={{background: 'var(--primary)', color: 'white', boxShadow: '0 5px 0 #b84a1e', minWidth: '160px', fontFamily: 'var(--font-bangers), cursive', fontSize: '1rem', letterSpacing: '1px', padding: '12px 32px'}}>
            Buy DOOD
          </a>
        </div>
        ...
        <div className="flex flex-col items-center justify-center gap-2">
          <button
            ...
            style={{border: '2px solid var(--primary)', minWidth: '375px', width: '375px'}
          >
            {copied ? (
